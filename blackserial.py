...
if __name__ == '__main__':
    ...
    common_group.add_argument('-f', '--format', help="Filter by payload output format", choices=['xml', 'json', 'yaml', 'base64', 'binary'])
    common_group.add_argument('-us', '--unsafe', help="Unsafe gadget chains like File Delete", action="store_true")    
